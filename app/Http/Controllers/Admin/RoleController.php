...
class RoleController extends Controller
{
    ...
    
    {
        ...
        notify()->success("Role Added Succesfully");
    ...
    public function update(Request $request, Role $role)
    {
       ...
       notify()->success("Role Updaed Succesfully");
       return redirect()->route('app.roles.index');
    }
    ...
    public function destroy(Role $role)
    {
        ...
        if($role->deleteable){
            $role->delete();
            notify()->success("Role Deleted Succesfully");  
        }else{
            notify()->error("Role can not be Deleted ");
        }
